...
################################################################################
## Form generated from reading UI file '20251002_draft_ver2KacAhV.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.pb_convert, 5, 0, 1, 5)
        ...
        self.le_x_max.setMaximumSize(QSize(70, 30))
        self.le_x_max.setFont(font)

        self.gridLayout.addWidget(self.le_x_max, 1, 5, 1, 1)

        self.le_time_min = QLineEdit(self.gridLayoutWidget)
        self.le_time_min.setObjectName(u"le_time_min")
        self.le_time_min.setMaximumSize(QSize(70, 30))
        self.le_time_min.setFont(font)

        self.gridLayout.addWidget(self.le_time_min, 3, 2, 1, 1)

        self.le_time_max = QLineEdit(self.gridLayoutWidget)
        self.le_time_max.setObjectName(u"le_time_max")
        self.le_time_max.setMaximumSize(QSize(70, 30))
        self.le_time_max.setFont(font)

        self.gridLayout.addWidget(self.le_time_max, 3, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.rb_4ch, 4, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.rb_psbp, 4, 2, 1, 1)
        ...
        self.le_y_min.setMaximumSize(QSize(70, 30))
        self.le_y_min.setFont(font)

        self.gridLayout.addWidget(self.le_y_min, 2, 2, 1, 1)

        self.le_x_min = QLineEdit(self.gridLayoutWidget)
        self.le_x_min.setObjectName(u"le_x_min")
        self.le_x_min.setMaximumSize(QSize(70, 30))
        self.le_x_min.setFont(font)

        self.gridLayout.addWidget(self.le_x_min, 1, 2, 1, 1)
        ...
        self.le_y_max.setMaximumSize(QSize(70, 30))
        self.le_y_max.setFont(font)

        self.gridLayout.addWidget(self.le_y_max, 2, 5, 1, 1)
        ...
        self.cb_amp = QCheckBox(self.gridLayoutWidget)
        self.cb_amp.setObjectName(u"cb_amp")

        self.gridLayout.addWidget(self.cb_amp, 5, 6, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"Amplitude", None))
    # retranslateUi
